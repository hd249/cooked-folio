...
export function Hero() {
  ...
  return (
    <section className="relative mb-10 font-mono">
      ...
      <div className="h-40 md:h-56 w-full relative mb-12 select-none pointer-events-none [mask-image:linear-gradient(to_bottom,transparent_0%,black_25%,black_75%,transparent_100%)]">
        <Image
          src={BANNER_IMAGE}
          alt="banner"
          fill
          className="object-cover transition-transform duration-700 hover:scale-105 opacity-80 md:opacity-90 grayscale-[0.2]"
          priority
        />
      </div>
